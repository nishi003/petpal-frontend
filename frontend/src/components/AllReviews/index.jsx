            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-6">
                    {reviews && reviews.map(review => (
                        <Review key={review.id} isSelfReview={isSelf} reviewID={review.id} name={review?.owner.name} rating={review.rating} content={review.content} timestamp={review.timestamp} hasReplies={review.hasReplies} avatar={review.owner.avatar}></Review>
                    ))}
                </div>
