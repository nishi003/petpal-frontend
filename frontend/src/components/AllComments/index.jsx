            ...
            <div className="flex flex-col gap-2">
                <div className="flex flex-col gap-6">
                    {comments && comments.map(comment => (
                        <Comment key={comment.id} id={comment.id} name={comment.owner.name} img={comment.owner.avatar} timestamp={comment.timestamp} content={comment.content} avatar={comment.owner}></Comment>
                    ))}
                </div>
